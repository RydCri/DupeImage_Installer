...
class DuplicateFinderApp:
    def __init__(self, master):
        ...
        style.configure('TFrame', background='#222222', foreground='#888888')
        style.configure('TLabel', background='#222222', foreground='#888888')
        style.configure('Success.TLabel', background='#222222', foreground='#888888', padding=5, font=('Arial', 10, 'italic'))
        ...
        self.folder_entry = ttk.Label(self.folder_frame, textvariable=self.target_folder,
                                      background='#444444', relief='groove', anchor='w',
                                      style='TLabel')
        ...
        self.status_label = ttk.Label(master, textvariable=self.status_text, padding="10", font=('Arial', 10, 'italic'), anchor='w', background='#222222')
    ...
    def select_folder(self):
        ...
        if folder_selected:
            ...
            self.folder_entry.config(style='TLabel', background='#333333', foreground='#888888')
            self.target_folder.set("No folder selected.")
